        ...
        <div className="flex items-center gap-8">
          ...
          <div className="relative">
            ...
            {isMenu && (
              ...
              >
                {user && user.email === "dipeshrajoria45@gmail.com" && (
                  <Link to={"./createItem"}>
                    <p
        ...
        <div className="relative">
          ...
          {isMenu && (
            ...
            >
              ...
              <p
                className="m-2 p-2 flex rounded-md shadow-md items-center justify-center gap-3 cursor-pointer hover:bg-red-400 bg-red-300
